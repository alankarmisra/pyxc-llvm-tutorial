...
---
# 16. Pyxc: Optimization and JIT Execution
...
Now let's try that earlier example again, this time with the REPL in chapter 16:
...
**Chapter 17** will add object file generation with optimization levels, so we can compile Pyxc code and call it from C++.
