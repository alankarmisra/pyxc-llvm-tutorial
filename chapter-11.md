# 11. Pyxc: Adding Debug Information
...
Welcome to Chapter 11 of the [Implementing a language with LLVM](chapter-00.md) tutorial. In chapters 1 through 8, we’ve built a decent little programming language with functions and variables. What happens if something goes wrong though, how do you debug your program?
...
## Compiling
```bash
cd code/chapter11 && ./build.sh
```

```bash
# Compile fib using pyxc
./code/chapter11/build/pyxc < code/chapter11/fib.pyxc |& clang -g -x ir - -o fib
```
...
If you want a practical handoff point, Chapter 12 is now that bridge.
