...
---
# 17. Pyxc: Object Files and Optimizations
...
Grab the code: [code/chapter17](https://github.com/alankarmisra/pyxc-llvm-tutorial/tree/main/code/chapter17)

Or clone the whole repo:
```bash
git clone https://github.com/alankarmisra/pyxc-llvm-tutorial
cd pyxc-llvm-tutorial/code/chapter17
```
...
int main(int argc, const char **argv) {
  cl::ParseCommandLineOptions(argc, argv, "pyxc chapter17\n");
...
**Chapter 18** adds debug information (`-g` flag) so we can debug Pyxc code with `lldb` and see source code in the debugger.
