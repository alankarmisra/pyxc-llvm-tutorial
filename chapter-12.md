# 12. Forward Function References and Mutual Recursion
...
Reference: `code/chapter13/pyxc.ebnf`
...
- `code/chapter13/test/c28_forward_call.pyxc`
- `code/chapter13/test/c28_mutual_recursion.pyxc`
- `code/chapter13/test/c28_signature_mismatch.pyxc`
...
```bash
code/chapter13/pyxc -i code/chapter13/test/c28_forward_call.pyxc
```
