...
Chapter 15 populated `TheFPM` with four passes chosen to match the Kaleidoscope tutorial:
...
Chapter 16 replaces this with LLVM's canonical pipelines. Two new managers are added:
