...
[Chapter 26](chapter-26.md) added methods. I can define behavior on a class and call it through `obj.method(args)`. But creating a class instance still means writing field assignments by hand:
