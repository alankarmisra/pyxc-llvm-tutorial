...
[Chapter 29](chapter-29.md) gave me type aliases, but the type system still can't express "a fixed number of these, sitting next to each other." For that I need arrays: `int[4]`, allocated on the stack, indexed with `arr[i]`.
