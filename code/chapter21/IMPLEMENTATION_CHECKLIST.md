...
This is the agreed implementation target for Chapter 16.
...
5. Tests
- Keep parser/type/lowering cases in `code/chapter16/test/`.
- Flip tests from `XFAIL` to passing as each feature lands.

## Done Criteria

- Chapter 16 tests for pointer type, address-of, indexing, and basic aliases pass.
