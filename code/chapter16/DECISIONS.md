# Chapter 15 Locked Decisions

These are pre-implementation decisions to keep Chapter 15 focused.
...
- Chapter 15 should reject alias cycles.

## 3) Syntax Freeze (Chapter 15)
...
- Use lit tests under `code/chapter15/test/`.
