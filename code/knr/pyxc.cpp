...
static map<string, Token> Keywords = {
    ...
    {"default", tok_default}, {"binary", tok_binary},
    {"unary", tok_unary},     {"var", tok_var},
    {"int", tok_int},         {"int8", tok_int8},
    {"int16", tok_int16},     {"int32", tok_int32},
    {"int64", tok_int64},     {"float", tok_float},
    {"float32", tok_float32}, {"float64", tok_float64},
    {"bool", tok_bool},       {"None", tok_none},
    ...
    {"sizeof", tok_sizeof},   {"type", tok_type},
    {"trait", tok_trait},     {"impl", tok_impl}};
