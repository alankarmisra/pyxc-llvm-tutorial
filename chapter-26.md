# 26. Program Arguments, scanf Baseline, Low-Level FD I/O, and ctype Helpers

Chapter 25 gave us separate compilation and multi-file linking.

Chapter 26 extends runtime interop in four practical directions:
...
In `code/chapter26/pyxc.cpp`, `GetOrCreateLibcIOFunction(...)` was extended.
...
```bash
code/chapter26/pyxc -o app code/chapter26/test/c26_main_argv_executable.pyxc
./app alpha beta
```
...
```bash
printf '42\n' | code/chapter26/pyxc -i code/chapter26/test/c26_scanf_int.pyxc
```
